...
EngineFunction::EngineFunction( XLlibid libid, XLstdid stdid, XLint32 opid, const std::string& name, const FncPtr& fncptr )
...
XLstatus EngineFunction::exec( XLpv* arg, XLpv* result )
{
